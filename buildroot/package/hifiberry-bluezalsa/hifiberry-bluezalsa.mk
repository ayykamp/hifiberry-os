...
# Enable LDAC
HIFIBERRY_BLUEZALSA_DEPENDENCIES += libldac libldacdec
HIFIBERRY_BLUEZALSA_CONF_OPTS += --enable-ldac
...
HIFIBERRY_BLUEZALSA_MAKE_ENV += LDAC_INCLUDE_DIR=/usr/include/ldac
HIFIBERRY_BLUEZALSA_MAKE_ENV += LDAC_LIB_DIR=/usr/lib

HIFIBERRY_BLUEZALSA_MAKE_ENV += LDAC_ABR_CFLAGS="-I$LDAC_INCLUDE_DIR"
HIFIBERRY_BLUEZALSA_MAKE_ENV += LDAC_ABR_LIBS="-L$LDAC_LIB_DIR -lldacBT_abr"
HIFIBERRY_BLUEZALSA_MAKE_ENV += LDAC_DEC_CFLAGS="-I$LDAC_INCLUDE_DIR"
HIFIBERRY_BLUEZALSA_MAKE_ENV += LDAC_DEC_LIBS="-L$LDAC_LIB_DIR -lldacdec"
HIFIBERRY_BLUEZALSA_MAKE_ENV += LDAC_ENC_CFLAGS="-I$LDAC_INCLUDE_DIR"
HIFIBERRY_BLUEZALSA_MAKE_ENV += LDAC_ENC_LIBS="-L$LDAC_LIB_DIR -lldacBT_enc"
